...
function Header() {
  ...
  return (
    <motion.div className='flex flex-col justify-center items-center text-center my-20'
       ...
       viewport={{once:true}}>
        <motion.div className='text-stone-500 inline-flex text-center gap-2 bg-white rounded-full px-6 py-1 border border-neutral-500'
        ...
        image</span></motion.h1>
        <motion.p className='text-center mt-5 max-w-xl mx-auto'
         initial={{opacity:0,y: 20}}
         animate={{opacity:1,y:0}}
         transition={{delay:0.6,duration:0.8}}>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Iure, saepe soluta. Officiis, provident consequatur cumque voluptatem molestiae</motion.p>
        <motion.button onClick={onClickHandler} className='sm:text-lg text-white bg-black w-auto mt-8 px-12 py-2.5 flex items-center gap-2 rounded-full'
          ...
          initial={{opacity:0 }}
          animate={{opacity:1 }}
          transition={{default:{duration:0.6},opacity:{delay:0.8,duration:1}}}
        >Generate Images
        ...
        className='mt-2 text-neutral-600'>Generated images</motion.p>
     </motion.div>
  )
}
