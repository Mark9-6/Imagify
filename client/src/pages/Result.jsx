...
function Result() {
  ...
  return (
    ...
    viewport={{once:true}}
    onSubmit={onSubmitHandler} className='flex flex-col min-h-[90vh] items-center'>
    <div>
    ...
    {!isImageLoaded &&  <div className='flex w-full max-w-xl bg-neutral-500 text-white text-sm p-0 mt-10 rounded-full'>

       <input 
       onChange={e=>setInput(e.target.value)}
       value={input}
        type='text' placeholder='paste prompt' className='flex-1 bg-transperent outline-none ml-8 max-sm:w-20 placeholder-color'/>
